...
//lily deller!
{
    public static void main(String[] args) 
    {
        ...
        System.out.print("Enter the number length in the first matrix:");
        p = sc.nextInt();    //Initialize first matrix size
        System.out.print("Enter the width in the first matrix:");
        q = sc.nextInt();   //Initialize first matrix size
        System.out.print("Enter the length in the second matrix:");
        m = sc.nextInt();   //Initialize second matrix size
        System.out.print("Enter the width in the second matrix:");
